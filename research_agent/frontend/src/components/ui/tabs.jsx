...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center gap-1 rounded-xl border border-glass-border bg-glass/30 p-1 backdrop-blur-xl",
      className
    )}
    {...props}
  />
...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-secondary/80 data-[state=active]:text-foreground data-[state=active]:shadow-sm",
